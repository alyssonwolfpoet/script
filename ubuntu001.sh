...
'Data de última modificação: 30/04/2024'''
''''''''''''''''''''''''''''''''''''''''''
"
sleep 5
...
androidStudio() {
	...
	wget -c https://redirector.gvt1.com/edgedl/android/studio/ide-zips/2023.2.1.24/android-studio-2023.2.1.24-linux.tar.gz -O android-studio.tar.gz
